...
<body>
  <div class="container">
    ...
    <div class="cover">
      <div class="front">
        <img src="../resources/images/frontImg.jpg" alt="">
        <div class="text">
      ...
      <div class="back">
        <img class="backImg" src="../resources/images/backImg.jpg" alt="">
        <div class="text">
    ...
    <div class="forms">
        <div class="form-content">
          ...
          <form action="{{URL::to('/client-dashboard')}}" method="POST">
            {{ csrf_field() }}
            <?php 
        ...
        <form action="{{URL::to('/signup')}}" method="POST">
          ...
          <?php 
              ...
              if($message_error){
                echo '<span class="text-alert">'.$message_error.'</span>';
